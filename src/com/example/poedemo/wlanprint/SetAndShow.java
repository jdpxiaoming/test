...
public class SetAndShow extends Activity implements OnClickListener,
	...
	public void onClick(View v) {
		...
		case R.id.btPrint: {
			...
			Pos.POS_S_TextOut(getString(R.string.sample_setandshow_01), 0,
					nScaleTimesWidth, nScaleTimesHeight, nFontSize, nFontStyle);
			Pos.POS_FeedLine();
			Pos.POS_S_TextOut(getString(R.string.sample_setandshow_02), 0,
					nScaleTimesWidth, nScaleTimesHeight, nFontSize, nFontStyle);
			Pos.POS_FeedLine();
			Pos.POS_S_TextOut(getString(R.string.sample_setandshow_03), 0,
					nScaleTimesWidth, nScaleTimesHeight, nFontSize, nFontStyle);
			for (int i = 0; i < 3; i++)
				Pos.POS_FeedLine();
			break;
